<template>
  <ul class="pagination" :class="[size && `pagination-${size}`, align && `justify-content-${align}`]">
    <li class="page-item prev-page" :class="{disabled: value === 1}">
      <a class="page-link" aria-label="Previous" @click="prevPage" v-shortkey="prevHotKey" @shortkey="prevPage">
    ...
    <li class="page-item next-page" :class="{disabled: value === totalPages}">
      <a class="page-link" aria-label="Next" @click="nextPage" v-shortkey="nextHotKey" @shortkey="nextPage">
...
export default {
  ...
  props: {
    ...
    prevHotKey: {
      type: Array,
      description: 'Keyboard hotkey for previous page',
    },
    nextHotKey: {
      type: Array,
      description: 'Keyboard hotkey for next page',
    },
  },
  computed: {
    totalPages() {
